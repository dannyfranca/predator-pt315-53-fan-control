...
use fan_control_core::{
    ...
    EvidenceTimestamp, FakePlatform, Fan, FanCommandEvidence, FanControlField, FanReadbackEvidence,
    FanReadbackField, FanReadbackPhase, FilePermissions, FirmwareAutoBaselineEnvironment,
    ...
    LiveLifecyclePowerObservation, LiveLifecycleProfileObservation,
...
use support::{PROTECTED_POLICY, compatibility_declaration, completed_calibration_record, sha256};
