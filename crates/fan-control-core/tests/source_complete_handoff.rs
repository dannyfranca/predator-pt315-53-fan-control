...
impl HandoffSandbox {
    fn new() -> Self {
        ...
        for overlay in [
            ...
            "crates/fan-control-core/src/baseline.rs",
            "crates/fan-control-core/src/compatibility.rs",
            "crates/fan-control-core/src/lib.rs",
            "crates/fan-control-core/src/preflight.rs",
            "crates/fan-control-core/tests/candidate_declarations.rs",
            "crates/fan-control-core/tests/firmware_auto_baseline.rs",
            "crates/fan-control-core/tests/qualification_ready_fake_platform.rs",
            "crates/fan-control-core/tests/read_only_preflight.rs",
            "crates/fan-control-core/tests/root_kernel_signer.rs",
